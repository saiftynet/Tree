...
Current [Version](https://github.com/saiftynet/Tree/blob/main/README.md#version)-0.04 HTML methods added
...
## Version
0.04
* Add methods to output tree as HTML (nested `<li>`sts or `<div>`s
